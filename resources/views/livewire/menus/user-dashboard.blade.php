<div>
    <div class="mb-1 w-full">
        <div>
            <flux:breadcrumbs>
                <flux:breadcrumbs.item href="{{ route('user.dashboard') }}">{{ __('Welcome') }} {{ Auth::user()->name }}
                    ...
                    <div wire:click="selectApartment({{ $apartment->id }})"
                        ...
                        <div class="flex items-center justify-between w-full">
                            <p class="text-gray-900 dark:text-white text-base font-bold truncate">
                                {{ $apartment->building_name }} - {{ $apartment->apartment_number }}
                            </p>
                            <div
                                class="inline-flex items-center gap-1 rounded-sm py-0.5 text-[10px] font-bold uppercase tracking-wider {{ strtolower($apartment->society->is_byelaws_available) === 'yes' ? 'bg-green-100 text-green-700' : 'bg-red-50 text-red-600' }}">
                                <flux:icon.document-text variant="mini" class="size-3 shrink-0" />
                                <span class="whitespace-nowrap">Byelaws:
                                    {{ $apartment->society->is_byelaws_available ?? 'No' }}</span>
                            </div>
                        </div>
                        <p class="text-gray-500 dark:text-gray-400 text-xs truncate">
                            {{ $apartment->society->society_name }}</p>
                        ...
                        <div>
                            @if ($needsAttention && $details->comment)
                                <div class="px-4 py-2 my-2 rounded-lg border-amber-400 border-2">
                                    <p class="text-md font-bold dark:text-white">Your Application for
                                        {{ $details->details_name }} {{ $details->apartment_number }} at
                                        {{ $details->society->society_name }} need attention.</p>
                            ...
                            <div class="flex flex-col gap-4">
                                <div
                                    class="rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow my-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 border-b border-gray-300 relative">
                                        <div class="p-2">
                                            <div
                                                ...
                                                <p class="text-lg font-bold text-gray-900 dark:text-white">
                                                    ...
                                                    <flux:badge color="blue" icon="building-office" size="sm">
                                                ...
                                                @for ($i = 1; $i <= 3; $i++)
                                                    ...
                                                    @if ($details->$name)
                                                        <div class="p-2 rounded-lg bg-gray-50/50 dark:bg-gray-700/30">
                                                            <p
                                                                class="text-[9px] uppercase font-bold text-gray-400 mb-0.5 tracking-wider">
                                                                Owner {{ $i }}</p>
                                                            <p
                                                                class="text-sm font-bold text-gray-700 dark:text-gray-300 truncate">
                                                                {{ $details->$name }}</p>
                                        ...
                                        <div class="p-2">
                                            @php
                                                ...
                                                // Global checks
                                                $allPending = $steps->every(
                                                    fn($s) => ($s['Status'] ?? '') === 'Pending',
                                                );
                                                $allApproved = $steps->every(
                                            ...
                                            @if (isset($steps) && $steps->isNotEmpty())
                                                            ...
                                                            if ($i === 0) {
                                                                ...
                                                                $colors[$i] =
                                                                    $status === 'Pending'
                                                                        ...
                                                                        : 'bg-green-500';
                                                                $icons[$i] =
                                                                    $status === 'Pending' ? 'fa-circle' : 'fa-check';
                                                            } elseif ($i === 1) {
                                                                // Step 2
                                                ...
                                                @endphp
                                                <div class="w-full">
                                                    <div data-dui-stepper-container data-dui-initial-step="1"
                                                        class="w-full mb-4">
                                                                ...
                                                                <div aria-disabled="false" data-dui-step
                                                                    ...
                                                                    <div class="relative">
                                                                        <span
                                                                            ...
                                                                            <i
                                                                                class="fa-solid {{ $icons[$i] }} text-white"></i>
                                                                        </span>
                                                                        <span
                                                                            class="absolute -bottom-6 start-0 whitespace-nowrap text-[10px] sm:text-xs {{ in_array($task['Status'], ['Pending', 'Rejected']) ? 'text-stone-500 font-normal' : 'text-stone-800 font-extrabold' }} dark:text-white">{{ $task['name'] }}
                                                                        </span>
                                                                    </div>
                                                                    @if (!$loop->last)
                                                                        <div
                                                                            class="flex-1 h-1 bg-gray-400 {{ $colors[$i] }}">
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            @endforeach
                                        ...
                                        @php
                                            ...
                                            $tasks = collect($statusData['tasks'] ?? []);
                                            $applicationStatus =
                                                $tasks->firstWhere('name', 'Application')['Status'] ?? null;
                                        @endphp

                                        @if ($applicationStatus !== 'Approved')
                                            <flux:tooltip content="Edit Apartment">
                                                <button
                                                    class="font-bold absolute top-0 right-0 px-2 py-1 border rounded-md cursor-pointer"
                                                    wire:click="verifyDetails({{ $details->id }})">
                                        ...
                                        @else
                                            <flux:tooltip content="View Apartment">
                                                <button
                                                    class="font-bold absolute top-0 right-0 px-2 py-1 border rounded-md cursor-pointer"
                                                    wire:click="viewDetails({{ $details->id }})">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-2 p-3">
                                        ...
                                        @php
                                            ...
                                            $verifyStatus =
                                                $tasks->firstWhere('name', 'Verify Details')['Status'] ?? null;
                                            $applicationStatus =
                                                $tasks->firstWhere('name', 'Application')['Status'] ?? null;
                                            $verificationStatus =
                                                $tasks->firstWhere('name', 'Verification')['Status'] ?? null;
                                            $generationStatus =
                                                $tasks->firstWhere('name', 'Certificate Generated')['Status'] ?? null;
                                        @endphp
                                        @php
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-2 p-3">
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_b')
                                            @php
                                                $fileUrl = asset(
                                                    'storage/society_docs/' . $details->byeLawCase->stampDutyProof,
                                                );
                                                $isApproved = $this->getFileStatus(
                                                    $statusData,
                                            ...
                                            @php
                                                $fileUrl = asset(
                                                    'storage/society_docs/' . $details->byeLawCase->transferorSignature,
                                                );
                                                $isApproved = $this->getFileStatus(
                                                    $statusData,
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_c')
                                            @php
                                                $fileUrl = asset(
                                                    'storage/society_docs/' . $details->byeLawCase->deathCertificate,
                                                );
                                                $isApproved = $this->getFileStatus(
                                                    $statusData,
                                            ...
                                            @php
                                                $fileUrl = asset(
                                                    'storage/society_docs/' . $details->byeLawCase->nominationRecord,
                                                );
                                                $isApproved = $this->getFileStatus(
                                                    $statusData,
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_a')
                                            @php
                                                $fileName = 'Appendix 2';
                                                $fileUrl = route('appendix.two', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_c')
                                            @php
                                                ...
                                                $fileUrl = route('appendix.fifteen', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_d')
                                            @php
                                                ...
                                                $fileUrl = route('appendix.sixteen', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
                                            ...
                                            @php
                                                ...
                                                $fileUrl = route('appendix.nineteen', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
                                        ...
                                        @if ($details->byeLawCase && $details->byeLawCase->membership_case == 'case_b')
                                            @php
                                                ...
                                                $fileUrl = route('appendix.twenty-part-one', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
                                            ...
                                            @php
                                                ...
                                                $fileUrl = route('appendix.twenty-part-two', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
                                            ...
                                            @php
                                                ...
                                                $fileUrl = route('appendix.twenty-one', [
                                                    'byelaws_id' => $details->byeLawCase->id,
                                                ]);
                                                $isApproved = $this->getFileStatus($statusData, $fileName);
                                            @endphp
