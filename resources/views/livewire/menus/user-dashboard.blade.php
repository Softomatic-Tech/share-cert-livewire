                    ...
                    <div class="p-4 rounded">
                        ...
                        <div class="mt-2 flex overflow-x-auto gap-2 whitespace-nowrap">
                            @if($details->agreementCopy)
                                <div class="inline-flex items-center justify-center rounded-full bg-stone-400 px-2 py-2 text-xs font-medium text-white dark:bg-gray-700 dark:hover:bg-gray-600">
