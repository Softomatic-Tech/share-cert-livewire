            ...
            <div class="card">
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-2">
                        <div>
                            <label for="csv_file">Society Name / सोसायटीचे नाव:</label>
                        ...
                        <div>
                            <label for="csv_file">Upload Document / दस्तावेज अप्लोड करा:</label>
                    ...
                    <div class="flex justify-between mt-4">
                        <flux:button variant="filled" type="button" wire:click="csvExport">{{ __('CSV EXPORT') }}
                        </flux:button>
