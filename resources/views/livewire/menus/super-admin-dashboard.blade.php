<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-zinc-200 dark:bg-zinc-600 cursor-pointer"
            wire:click="redirectToSocietyList">
            <div class="flex items-center justify-center text-center gap-2">
                <span
                    class="w-10 h-10 bg-amber-500 text-white rounded-full flex items-center justify-center shadow-md hover:bg-zinc-600"><i
        ...
        <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-zinc-200 dark:bg-zinc-600 cursor-pointer"
            wire:click="markRoleBySuperAdmin">
            <div class="flex items-center justify-center text-center gap-2">
                <span
                    class="w-10 h-10 bg-amber-500 text-white rounded-full flex items-center justify-center shadow-md hover:bg-zinc-600"><i
