<section class="w-full">
    ...
    <div class="rounded-lg shadow-lg px-6 py-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form wire:submit.prevent="csvImport">
                                    ...
                                    <div class="p-4">
                                        <flux:button variant="filled" class="w-full" type="button" wire:click="csvExport">{{ __('CSV EXPORT') }}</flux:button>
                                    </div>
                                    <div class="p-4">
                                        <flux:button variant="primary" class="w-full" type="submit" wire:loading.attr="disabled" wire:target="csv_file, csvImport">{{ __('CSV IMPORT') }}</flux:button>
                                    </div>
                                    @else
