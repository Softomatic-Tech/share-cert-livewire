    ...
    <div class="w-full">
        ...
        <div class="rounded-lg shadow-lg py-4 px-6">
            ...
            <form wire:submit.prevent="updateSocietyDetails">
                ...
                <div class="card shadow-sm border-0 mb-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            ...
                            <flux:input type="number" :label="__('Total No of Building :')" wire:model="total_building" />
                ...
                <div class="card shadow-sm border-0 mb-6">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded-xl bg-gray-50/50">
                            <flux:radio.group wire:model.live="is_byelaws_available" :label="__('Is bye laws available?')" class="flex-row gap-4">
                            ...
                            <div class="mt-6 space-y-3 animate-in fade-in slide-in-from-top-1">
                                <flux:radio.group wire:model.live="membership_case" :label="__('Select Membership Case:')">
                                ...
                                @if($membership_case === 'case_a')
                                    <div class="mt-8 space-y-6 pt-6 border-t border-gray-100">
                                        <flux:heading size="sm" class="flex items-center gap-2">
                                            ...
                                            <flux:label class="font-bold"><u>Additional Membership Details</u></flux:label>
                                        </flux:heading>
                                        
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <flux:field>
                                                <flux:input :label="__('Applicant Name')" wire:model="applicant_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Father/Husband Name')" wire:model="father_husband_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Deceased Member Name')" wire:model="deceased_member_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Builder Name')" wire:model="builder_name" />
                                            </flux:field>
                                            <flux:field>
                                            ...
                                            <flux:field>
                                                <flux:input :label="__('Monthly Income')" wire:model="monthly_income" prefix="₹" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:textarea :label="__('Residential Address')" wire:model="residential_addr" rows="2" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:textarea :label="__('Office Address')" wire:model="office_addr" rows="2" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Flat Area (Sq. Meters)')" wire:model="flat_area_sq_meters" />
                                            </flux:field>
                                        </div>

                                        <div class="space-y-4 p-4 rounded-xl bg-blue-50/30 border border-blue-100">
                                            <flux:label class="font-bold"><u>Other Particulars of Plot/Flat/House:</u></flux:label>
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <flux:input :label="__('Name of Person1')" wire:model="other_person_name1" />
                                                <flux:input :label="__('Location of Plot/Flat1')" wire:model="other_property_location1" />
                                                <flux:textarea :label="__('Particulars of Owned Property1')" wire:model="other_property_particulars1" placeholder="Owned by applicant or family members" rows="2" />
                                                <flux:textarea :label="__('Reason for necessity of flat1')" wire:model="reason_for_flat1" rows="2" />
                                            </div>
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <flux:input :label="__('Name of Person2')" wire:model="other_person_name2" />
                                                <flux:input :label="__('Location of Plot/Flat2')" wire:model="other_property_location2" />
                                                <flux:textarea :label="__('Particulars of Owned Property2')" wire:model="other_property_particulars2" placeholder="Owned by applicant or family members" rows="2" />
                                                <flux:textarea :label="__('Reason for necessity of flat2')" wire:model="reason_for_flat2" rows="2" />
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($membership_case === 'case_b')
                                    <div class="mt-8 space-y-6 pt-6 border-t border-gray-100">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <flux:field>
                                                <flux:input :label="__('Transferee Name')" wire:model="transferee_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Transferor Name')" wire:model="transferor_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Distinctive No From')" wire:model="distinctive_no_from" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Distinctive No To')" wire:model="distinctive_no_to" />
                                            </flux:field>
                                            <flux:field>
                                            ...
                                            <flux:field>
                                                <flux:input :label="__('Transfer Fee')" wire:model="transfer_fee" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Transfer Premium Amount')" wire:model="transfer_premium_amount" />
                                            </flux:field>
                                        </div>
                                        <flux:heading size="sm" class="flex items-center gap-2">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <flux:field>
                                                <flux:input :label="__('Ground 1')" wire:model="transfer_ground_1" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Ground 2')" wire:model="transfer_ground_2" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Ground 3')" wire:model="transfer_ground_3" />
                                            </flux:field>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($membership_case === 'case_c')
                                    <div class="mt-8 space-y-6 pt-6 border-t border-gray-100">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <flux:field>
                                                <flux:input type="date" :label="__('Date of Death')" wire:model="date_of_death" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input type="number" :label="__('No of Shares')" wire:model="society_shares" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Occupation')" wire:model="occupation" />
                                            </flux:field>
                                ...
                                @if($membership_case === 'case_d')
                                    <div class="mt-8 space-y-6 pt-6 border-t border-gray-100">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <flux:field>
                                                <flux:input type="text" :label="__('Residential Address')" wire:model="residential_addr" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Distinctive No From')" wire:model="distinctive_no_from" />
                                            </flux:field>
                                            ...
                                            <flux:field>
                                                <flux:input type="time" :label="__('Inspection From')" wire:model="inspection_time_from" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input type="time" :label="__('Inspection To')" wire:model="inspection_time_to" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Floor No')" wire:model="floor_no" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Flat Bearing No')" wire:model="flat_bearing_no" />
                                            </flux:field>
                                        </div>
                                        <flux:heading size="sm" class="flex items-center gap-2">
                                            <u>Heir Details</u>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <flux:field>
                                                <flux:input :label="__('Witness Name')" wire:model="witness_name" />
                                            </flux:field>
                                            <flux:field>
                                                <flux:input :label="__('Witness Address')" wire:model="witness_address" />
                                            </flux:field>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @php
                                    ...
                                    $specializedColumns = ['allotmentMembershipLetter','stampDutyProof', 'transferorSignature', 'deathCertificate', 'nominationRecord', 'successionCertificate'];
                                @endphp

                                @if(count($currentSpecializedLabels) > 0)
                                    <div class="mt-8 pt-6 border-t border-gray-100">
                                        <flux:heading size="sm" class="mb-4">Case Specific Document Uploads</flux:heading>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            @foreach($specializedColumns as $col)
                                                ...
                                                <div class="p-4 border rounded-xl bg-gray-50/30">
                                                    ...
                                                    <div class="space-y-3" wire:key="spec-file-{{ $col }}-{{ $fileKey }}">
                                                        <flux:input type="file" wire:model="{{ $newFileProp }}" />
                                                        @error($newFileProp) <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
                                                        
                                                        <div class="flex gap-2">
                                                            @if($existingFile)
                                                                <flux:button variant="primary" size="sm" icon="eye" href="{{ asset('storage/society_docs/'.$existingFile) }}" target="_blank">View {{ $label }}</flux:button>
                                                            @endif
                ...
                <div class="card shadow-sm border-0 mb-6">
                    <div class="card-header font-bold text-lg bg-white py-4 border-b">Section 3: Standard Document Uploads</div>
                    <div class="card-body">
                        @php
                            ...
                            $standardColumns = ['agreementCopy', 'memberShipForm', 'allotmentLetter', 'possessionLetter'];
                        @endphp
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @foreach($standardColumns as $col)
                                ...
                                <div class="p-4 border rounded-xl">
                                    <flux:label class="font-bold mb-2 block">{{ $label }}</flux:label>
                                    <div class="space-y-3" wire:key="std-file-{{ $col }}-{{ $fileKey }}">
                                        <flux:input type="file" wire:model="{{ $newFileProp }}" />
                                        @error($newFileProp) <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
